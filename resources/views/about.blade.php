...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS Files -->
        <link href="{{ asset('css/champs.css') }}" rel="stylesheet">
    </head>
   <!-- Cuerpo de página -->
  <body>
    <!-- Barra de navegación -->
    <header>
      <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="#">
          <img src="/img/leagueoflegends_94793.svg" width="50" height="50" class="d-inline-block align-top" alt="Logo de League of Stats. Barra de navegación">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-bottom" aria-labelledby="menuDesplegableDescubrir">
                <a class="dropdown-item" href="stats.html">ESTADÍSTICAS</a>
                <a class="dropdown-item" href="rotacion.html">ROTACIÓN GRATUITA SEMANAL</a>
                <a class="dropdown-item" href="status.html">ESTADO DEL SERVIDOR</a>
              </div>
            </li>
            <li class="nav-item">
          ...
          <div class="ml-auto">
            <button class="btn my-2 text-light botonInicioSesion">INICIA SESIÓN</button>
            <button class="botonRegistro">REGÍSTRATE</button>
          </div>
        </div>
      </nav>
    </header>
    ...
    <div id="tecnoBack">
      ...
      <div id="back">
        <a href="https://laravel.com/" data-toggle="tooltip" data-placement="bottom" title="Laravel">
          <img src="/img/technologies/Laravel.jpg" title="Laravel" alt="Icono de Laravel. Página Sobre Nosotros">
        </a>
        <a href="https://www.php.net/" data-toggle="tooltip" data-placement="bottom" title="PHP">
          <img src="/img/technologies/PHP.jpg" alt="Icono de PHP. Página Sobre Nosotros">
        </a>
        <a href="https://www.mysql.com/" data-toggle="tooltip" data-placement="bottom" title="MySQL">
          <img src="/img/technologies/MySQL.jpg" alt="Icono de MySQL. Página Sobre Nosotros">
        </a>
        <a href="https://www.phpmyadmin.net/" data-toggle="tooltip" data-placement="bottom" title="phpMyAdmin">
          <img src="/img/technologies/phpMyAdmin.jpg" alt="Icono de phpMyAdmin. Página Sobre Nosotros">
        </a>
        <a href="https://www.gitkraken.com/" data-toggle="tooltip" data-placement="bottom" title="GitKraken">
          <img src="/img/technologies/GitKraken.jpg" alt="Icono de phpMyAdmin. Página Sobre Nosotros">
        </a>
      </div>
    </div>
    ...
    <section id="video">
      <div>
        ...
        <video autoplay loop muted id="frontal" width="1680" height="650">
          ...
          <img src="/img/error_video.png" alt="Su navegador no soporta HTML5. Apartado Multimedia">
        ...
        <div class="logoFrontal">
          <img src="/img/logo_original.png" width="600" height="264" alt="Logo League Of Legends. Apartado Multimedia">
        </div>
      </div>
    </section>
      ...
      <div>
        ...
        <div>
          <a href="https://apps.apple.com/es/app/league-of-legends-friends/id1077150310?ls=1">
            <img src="/img/download_appStore.svg" alt="Descarga APP Store. Apartado Plataformas" width="110" height="37">
          </a>
          <a href="https://play.google.com/store/apps/details?id=com.riotgames.mobile.leagueconnect&hl=es">
            <img src="/img/download_googlePlay.svg" alt="Descarga Google Play. Apartado Plataformas" width="141" height="55">
          </a>
        </div>
      </div>
    </section>
    <div>
      <div id="enlaces">
        <ul>
          ...
          <li>
            <a href="status.html">ESTADO DEL SERVIDOR</a>
          </li>
          <li>
            <a href="contact.html">AYÚDANOS A MEJORAR</a>
          </li>
          <li>
      ...
      <div id="calificaciones">
        <div>
          <a href="https://www.pegi.info/">
            <img src="/img/logo_pegi.svg" alt="Pegi 12. Footer" width="75" height="55">
          </a>
          <a href="http://www.usk.de/en">
            <img src="/img/logo_usk.png" alt="USK 12. Footer" width="55" height="55">
          </a>
        </div>
      </div>
    </div>
