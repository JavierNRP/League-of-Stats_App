...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- Sección de los Introducción a Campeones -->
          ...
          <div id="filter">
            <form>
              <div class="form-group">
                <input id="buscarChamp" type="text" class="fas form-control" placeholder="&#xf002"/>
              </div>
            </form>
            <ul>
        ...
        <!-- JavaScript File -->
        <script type="module" src="/js/champs/champs.js"></script>
      </body>
