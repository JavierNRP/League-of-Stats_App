...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- Sección de los Introducción a las Estadísticas -->
        ...
        <section id="content">
            <form id="search" class="align-items-center">
              ...
              <button class="fas" type="button" id="searchButton">&#xf002</button>
            </form>
          <div id="main"></div>
          <div id="history">
            <div id="mastery"></div>
        ...
        <!-- JavaScript File -->
        <script type="module" src="/js/stats/stats.js"></script>
      </body>
