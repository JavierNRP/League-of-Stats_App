...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- Sección de la Introducción a la Página de Rotación Gratuita Semanal -->
        ...
        <!-- Sección de la Rotación Gratuita Semanal -->
        <section id="content">
          <div id="main">
            <div id="rotacion">
        ...
        <!-- JavaScript File -->
        <script type="module" src="/js/rotacion/rotacion.js"></script>
      </body>
