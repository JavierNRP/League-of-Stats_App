...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ asset('/champions') }}">CAMPEONES</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-bottom" aria-labelledby="menuDesplegableDescubrir">
                  <a class="dropdown-item" href="{{ asset('/stats') }}">ESTADÍSTICAS</a>
                  <a class="dropdown-item" href="{{ asset('/rotation') }}">ROTACIÓN GRATUITA SEMANAL</a>
                  <a class="dropdown-item" href="{{ asset('/status') }}">ESTADO DEL SERVIDOR</a>
                </div>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ asset('/about') }}">SOBRE NOSOTROS</a>
              </li>
            </ul>
            <div class="ml-auto">
              @if (Route::has('login'))
                  <div class="top-right links">
                      ...
                      @else
                          <button class="btn my-2 text-light botonInicioSesion">
                            <a class="text-light" style="text-decoration: none;" href="{{ route('login') }}">INICIA SESIÓN</a>
                          </button>
                          @if (Route::has('register'))
                          <button class="botonRegistro">
                            <a class="text-light" style="text-decoration: none;" href="{{ route('register') }}">REGÍSTRATE</a>
                          </button>
                          @endif
                      @endauth
                  </div>
    ...
    <!-- INICIO. Contenido de cada página -->
    <main>
        @yield('content')
    </main>
    <!-- FINAL. Contenido de cada página -->

    <!-- INICIO. Sección de Multimedia -->
    <section id="video">
        <div>
          <p class="infoLateral">MULTIMEDIA <i class="fas fa-video"></i></p>
          <video autoplay loop muted id="frontal" width="1680" height="650">
            <source src="{{ asset('video/videoMP4_frontal.mp4') }}" type="video/mp4">
            <source src="{{ asset('video/videoMP4_frontal.webm') }}" type="video/webm">
    ...
    <!-- FINAL. Sección de Multimedia -->
    </body>
    <!-- FINAL. Cuerpo de página -->

  <!-- INICIO. Pie de página -->
  <footer>
    <!-- INICIO. Sección de Disponibilidad en Plataformas -->
    ...
    <!-- FINAL. Sección de Disponibilidad en Plataformas -->
    <div>
      <div id="enlaces">
        <ul>
          <li>
          ...
          <li>
            <a href="{{ asset('/status') }}">ESTADO DEL SERVIDOR</a>
          </li>
          <li>
            <a href="{{ asset('/contact') }}">AYÚDANOS A MEJORAR</a>
          </li>
          <li>
            <a href="{{ asset('/about') }}">SOBRE NOSOTROS</a>
          </li>
        </ul>
      </div>
      <div id="logo_riot">
